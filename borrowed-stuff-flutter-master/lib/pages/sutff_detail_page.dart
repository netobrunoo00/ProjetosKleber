...
class _StuffDetailPageState extends State<StuffDetailPage> {
  ...
  void initState() {
    ...
    if (widget.editedStuff != null) {
      ...
      _telefoneController.text = _currentStuff.telefone;
      ;
    }
  }
  ...
  _buildTelefoneInputField(){
    return TextFormField(
      ...
      validator: (value) {
        return Validator.isTelefoneWithCorretNumberGaranted(value);
      },
    );
  }
  ...
  _buildDateInputField() {
    return DateTimeField(
      ...
      validator: (date) {
        return Validator.isDateLowerToday(date);
      },
    );
  }
